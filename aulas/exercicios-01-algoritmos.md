...
## Capítulo 2: Ordenação por seleção (_Arrays_ e Listas Encadeadas)

**2.1 Aplicativo de finanças com muitas inserções e poucas leituras. _Array_ ou Lista Encadeada?**

**2.2 Fila de pedidos de restaurante (inserir no final, remover do início). Array ou lista encadeada?**


## Capítulo 3: Recursão e a Pilha de Chamadas (_Call Stack_)

**3.1 Quais informações você pode retirar baseando-se apenas em uma pilha de chamada (_call stack_)?**

**3.2 O que acontece com a pilha quando a função recursiva fica executando infinitamente?**

## Referências

BHARGAVA, Aditya Y. **Entendendo algoritmos: um guia ilustrado para programadores e outros curiosos**. 1. ed. São Paulo: Novatec Editora, 2017.